...
3. **Hash pairs of peaks** `(freq1, freq2, dt)` -> compact fingerprints.
...
Open **http://localhost:8000**, hit the mic button, play a song you've added -- get the title.
...
<p align="center"><i>Made with love in Madagascar. Veloma!</i></p>
